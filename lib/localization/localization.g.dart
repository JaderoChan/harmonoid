...
class LocalizationBase extends Values {
  ...
  Future<void> set({required LocalizationData value}) async {
    ...
    SETTINGS_SECTION_LASTFM_SUBTITLE = map['SETTINGS_SECTION_LASTFM_SUBTITLE']!;
    SETTINGS_SECTION_LASTFM_TITLE = map['SETTINGS_SECTION_LASTFM_TITLE']!;
